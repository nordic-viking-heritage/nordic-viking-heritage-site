(() => {
  ...
  // Permanent Crew Honors Archive. Compact gallery; artwork opens through the site's existing zoomable image viewer.
    ...
    honors.insertAdjacentHTML('afterend', `
      <section class="parchment" id="crew-honors-archive">
        <div class="wrap">
          ...
          <div class="crew-honors-archive-grid" style="display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,240px));gap:1.25rem;align-items:start">
