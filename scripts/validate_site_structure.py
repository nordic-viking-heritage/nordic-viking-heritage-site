...
if roll_cards:
    ...
    require(len(entries) >= 56, f'Ship\'s Roll appears truncated: only {len(entries)} ordinary entries found')
else:
...
require('CREW HONORS — DAY 22' in honors, 'Current Crew Honors is not Day 22')
require('day-22-crew-honors.jpg' in honors, 'Current Crew Honors is not using Day 22 artwork')
for token in ('JEFFERYCALLEN', 'FINN', 'ОЛЬГА', 'UNN', 'MIAMIMASON', 'AUD'):
    require(token in honors, f'Current Crew Honors is missing {token}')
require('CREW HONORS — DAY 21' not in honors, 'Day 21 is still present in current Crew Honors')
require('id="honors-day-22"' not in html, 'Duplicate standalone Day 22 Crew Honors section exists')
...
# Voyage Archive continuity through Day 22.
...
approved_archive_images = {
    22: 'day-22-viking-dispatch.jpg', 21: 'day-21-viking-dispatch.jpg',
    20: 'day-20-viking-dispatch.jpg', 19: 'day-19-viking-dispatch.jpg',
    18: 'day-18-viking-dispatch.png', 17: 'day-17-viking-dispatch.png',
    16: 'day-16-dispatch.png', 15: 'day-15-dispatch.jpg',
    14: 'day-14-dispatch.jpg', 13: 'day-13-dispatch.jpg',
    12: 'day-12-dispatch.jpg', 11: '3603CAC6-D075-49DC-A4AC-C0DA57129282.png',
...
require('DAY 22 · 97 VIKINGS · 40,120,041 STEPS · ONE LIVING SAGA' in html,
